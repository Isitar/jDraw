...
public class LineTool implements DrawTool {
	...
	/**
	 * Temporary variable. During line creation (during a mouse down -
	 * mouse drag - mouse up cycle) this variable refers to the new line
	 * that is inserted.
	 */
	private Line newLine = null;

	/**
	 * Temporary variable. During line creation this variable refers to the
	...
	/**
	 * Activates the Line Mode. There will be a specific menu added to the
	 * menu bar that provides settings for Line attributes
	 */
	@Override
	...
	/**
	 * Initializes a new Line object by setting an anchor point where the
	 * mouse was pressed. A new Line is then added to the model.
	 * 
	 * @param x
	...
	public void mouseDown(int x, int y, MouseEvent e) {
		...
		newLine = new Line(new Point(x, y), new Point(x, y));
	...
	public void mouseDrag(int x, int y, MouseEvent e) {
		...
		this.context.showStatusText("Anchor: " + r.x + ";" + r.y + " End: " + (r.x + r.width) + ";" + (r.y + r.height));
	}
